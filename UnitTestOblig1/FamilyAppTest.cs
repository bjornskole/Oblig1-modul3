...
namespace UnitTestOblig1
{
    ...
    public class FamilyAppTest
    {
        ...
        public void Test()
        {
            ...
            var expectedResponse = "Haakon Magnus (Id=3) Født: 1973 Far: Harald (Id=6) Født: 1937\n"
                   + "  Barn:\n"
        ...
        public void TestNoChildren()
        {
            ...
            var expectedResponse = "Sverre Magnus (Id=1) Født: 2005 Far: Haakon Magnus (Id=3) Født: 1973";
            Assert.AreEqual(expectedResponse, actualResponse);
        }
    }
}
